...
import { Button,Input, Select, StatusBadge, Card, Modal } from './components/ui';
...
export default function App() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-4 sm:p-8 font-sans">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <Card title="Card Component" className="lg:col-span-2">
                    <div className="space-y-4">
                        ...
                        <Card className="shadow-none border border-indigo-200 bg-indigo-50/50" title="Nested Card Example">
                ...
                <Card title="Form Controls & Error States" className="lg:col-span-2">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Input
                            ...
                            disabled
                        />
                        <Button variant="primary" onClick={() => console.log('Form Submitted!')}>
                            Submit Form Data
                        </Button>
                    </div>
                </Card>
            ...
            >
                <p className="mb-4">
                    This modal should appear centered on the screen and have a darkened backdrop.
                    It should close when you click the 'Cancel' button, the close icon, or the backdrop.
                </p>
                <div className="flex justify-end gap-3">
                    <Button variant="secondary" onClick={() => setIsModalOpen(false)}>Cancel</Button>
                    <Button variant="primary" onClick={() => { console.log('Action Confirmed!'); setIsModalOpen(false); }}>Confirm Action</Button>
                </div>
            </Modal>
        </div>
    );
